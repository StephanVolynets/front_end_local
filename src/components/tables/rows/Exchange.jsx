      ...
      <tr className={styles.row} onClick={onClick}>
        <td className={styles.column1} data-label="Rating">
          <div className={styles.column1Content}>
            ...
            <p className={styles.name}>{exchange?.name}</p>
            <StarsViewer reviewAverage={exchange?.rating} className={styles.starsViewer}/>
        ...
        <td className={styles.column2} data-label="Buy price">
          <p className={styles.buyPrice}>US$ {formatThousands(exchange?.buyPrice)}</p>
        </td>
        ...
        <td className={styles.column4} data-label="Sell price">
          <p className={styles.sellPrice}>US$ {formatThousands(exchange?.sellPrice)}</p>
        </td>
        <td>
